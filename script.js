...
document.addEventListener('DOMContentLoaded', function() {
    ...
    loginForm.addEventListener('submit', function(event) {
        ...
        // 模拟登录成功
        showAnimeNotification('登录成功！欢迎回到火花课堂', 'success');
    ...
    signupForm.addEventListener('submit', function(event) {
        ...
        // 这里只是示例，实际应该连接到后端进行注册
        console.log('注册信息:', { email, password, phone, nickname });
        
        // 模拟注册成功
        showAnimeNotification('注册成功！欢迎加入火花课堂', 'success');
    ...
    function animateModalExit(modalContent, callback) {
        modalContent.style.opacity = '1';
        modalContent.style.transform = 'scale(1) translateY(0)';
        modalContent.style.transition = 'all 0.3s cubic-bezier(0.6, -0.28, 0.735, 0.045)';
